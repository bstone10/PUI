...
// FLAG VARIABLES FOR SELECTED FIELDS OF THE DROPDOWN
var choices = {
    flavor: null,
    style: null,
    feel: null,
...
// AGE VERIFICATION FUNCTION - CHECKS WHETHER AGE IS > 21
function verifyAge() {
...
// CHECKS THAT ALL FIELDS HAVE BEEN FILLED BEFORE ALLOWING USER TO CONTINUE
...
// GENERATES A RANDOM DRINK AND STORES IT IN LOCAL STORAGE
...
// DROPDOWN FUNCTIONALITY, STORES THE INPUT AS WELL AS UPDATES THE DOM TO REFLECT CHANGES
DropDown.prototype = {
    initEvents : function() {
        var obj = this;
        ...
        //SENDS USER INPUT TO LOCAL STORAGE
...
//CHANGES THE RESTING STATE OF THE DROPDOWN TO HAVE THE SELECTED OPTION 
...
//CLEARS LOCAL STORAGE, NOT USED IN THE SITE BUT CREATED FOR DEBUGGIN IN CONSOLE
function clearItems() {
    localStorage.setItem("myChoices", JSON.stringify(new Object()));
}

//DISPLAYS 3 VARIATIONS OF THE USER'S CUSTOM COCKTAIL
function myChoices() {

    //DISPLAYS THE SELECTED INPUTS AT THE TOP IN TEXT
    ...
    //RANDOMLY SELECTS AN INGREDIENT FROM THE DICTIONARY
    //FOR FLAT STYLE, IT DOES NOT SELECT ONE DUE TO FLAT COCKTAILS HAVING LESS INGREDIENTS
    if (choices.style === "Flat") {
        ...
        //FILLS HTML WITH THE UPDATED INFORMATION BY MODIFYING THE DOM
        ...
        //ALL OTHER CHOICES RESULT IN 3 INGREDIENT RECIPES
        var1 = [ingredients[choices.flavor][Math.floor(Math.random() * ingredients[choices.flavor].length)],
